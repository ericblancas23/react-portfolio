...
export const NavBar = () => (
  <div className="nav">
      ...
      <a className="navbar-brand" style={{color: "white"}} href="https://drive.google.com/file/d/1ngzxPG9Kawhp-_g7nSXKjvMB5vxQdw9K/view?ths=true" style={{ marginLeft: "1cm"}}>Resume</a>
